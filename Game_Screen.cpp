...
Game_Screen::Game_Screen(sf::Texture* playerTexture, sf::Texture* enemyTexture, sf::Texture* groundTexture, sf::Texture* floorTexture, sf::Texture* bulletTexture, sf::Texture* healthTexture):
...
void Game_Screen::Loop(sf::RenderWindow& window, sf::View &view, float deltaTime)
{
    input();
